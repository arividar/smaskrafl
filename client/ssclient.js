...
(function() {
  ...
  drawTiles = function(x1, y1, x2, y2) {
    ...
    gridHtml = '';
    for (x = _i = 0, _ref = tiles.length; 0 <= _ref ? _i < _ref : _i > _ref; x = 0 <= _ref ? ++_i : --_i) {
      gridHtml += '<ul>';
      for (y = _j = 0, _ref1 = tiles.length; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; y = 0 <= _ref1 ? ++_j : --_j) {
  ...
  handleMessage = function(message) {
    var content, currPlayerNum, moveScore, newWords, nonTurnTimer, player, players, swapCoordinates, tick, turnTimer, type, winner, _ref, _ref1, _ref2, _ref3;
    _ref = typeAndContent(message), type = _ref.type, content = _ref.content;
    switch (type) {
      case 'welcome':
        _ref1 = JSON.parse(content), players = _ref1.players, currPlayerNum = _ref1.currPlayerNum, tiles = _ref1.tiles, myNum = _ref1.yourNum, newWords = _ref1.newWords, turnTime = _ref1.turnTime;
      ...
      case 'moveResult':
        _ref2 = JSON.parse(content), player = _ref2.player, swapCoordinates = _ref2.swapCoordinates, moveScore = _ref2.moveScore, newWords = _ref2.newWords;
      ...
      case 'tick':
        ...
        break;
      case 'gameOver':
        _ref3 = JSON.parse(content), winner = _ref3.winner, myNum = _ref3.yourNum;
